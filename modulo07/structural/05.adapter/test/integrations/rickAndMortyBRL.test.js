...
describe("#RickAndMortyBRL", () => {
  ...
  test("#getChractersJSON should return a list of Character Entity", async () => {
    ...
    const result = await RickAndMortyBRL.getChractersFromJSON();
    expect(result).toEqual(expected);
  });
  test("#getChractersJSON should return an empty list if the API returns nothing", async () => {
    const response = JSON.parse(
